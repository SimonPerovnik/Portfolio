...
for actF in actF_list:
  ...
  plt.plot(epochs_list, acc_list,label=actF + ' - train', marker='o')
  plt.plot(epochs_list, acc_train_list,label=actF + ' - test', ls='dotted', color= 'C' + str(actF_list.index(actF)))
  print('*************************************************************************************************************')
  print(actF)

plt.legend(frameon = True, fancybox = True, facecolor='white', framealpha=1)
plt.title('Mreža (input -> $64$ -> $10$)')
