...
matplotlib.rcParams["savefig.directory"] = r"E:\Faks\4.letnik\Modelska_analiza_I\111\slike"

PlotData = 0
nIzguba = rnd.randint(0, 1399)
nSignal = rnd.randint(nIzguba, 1400)
...
plt.scatter(x[nIzguba], y[nIzguba], label ='prekintev signala', c = 'r', marker = 'x')
plt.scatter(x[nSignal], y[nSignal], label ='ponovna vpostavitev signala', c = 'r', marker = 'x')
plt.xlabel('x')
plt.ylabel('y')
